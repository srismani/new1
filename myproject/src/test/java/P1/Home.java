...
public class Home 
{
  ...
  public void signup() throws Exception
  {
	  ...
	  Thread.sleep(2000);
	  driver.findElement(By.xpath("//*[@data-code='1']")).click();
	  driver.findElement(By.id("mobile")).sendKeys("4088584964");
  ...
  public void login() throws Exception
  {
	  open_url();
	  Reporter.log("=================Login===============");
	  driver.findElement(By.name("username")).sendKeys("srisnagamani");
	  driver.findElement(By.name("passwd")).sendKeys("srisai123");
